...
public static class SafetyGuard
{
        ...
        bool useSnapshot = false)
    {
        ...
        {
            issues.Add(new SafetyIssue(SafetySeverity.Warning, CodeSourceIsLiveSystem,
                "원본이 현재 실행 중인 시스템 디스크인데 스냅샷을 쓰지 않습니다. " +
                "복제 중에도 파일이 계속 바뀌므로 결과물이 일관되지 않고 부팅되지 않을 수 있습니다. " +
                "VSS 스냅샷 사용을 권장합니다."));
        }
